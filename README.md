...
- Apply **Google Consent Mode v2** default signals
- Configure consent defaults by **region** (e.g., EEA/UK/CH vs Rest of World)
- Set a Google `developer_id`
...
7. Trigger it on **Consent Initialization – All Pages**
